<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\phpstudy\PHPTutorial\WWW\wg\public/../application/index\view\login\login.html";i:1554187869;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="content">
	...
	<div class="right">
		<div class="box">
			...
			<button id="button" onclick="check()">确认登录</button>
		</div>
	</div>
</div>
</body>
