<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"D:\wamp64\www\moban\public/../application/index\view\index\index.html";i:1553330852;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div id="header">
    ...
    <ul class="nav_list">
        <li><a href="index.html"><p>首页</p><span> helll</span></a></li>
        <li><a href="find.html"><p>客源查询</p><span>222</span></a></li>
        <li><a href="ad.html"><p>广告管理</p><span>333</span></a></li>
        <li><a href="custom.html"><p>客服帮助</p><span>HELP</span></a></li>
    </ul>
</div>
<!--内容区-->
<div class="content">
