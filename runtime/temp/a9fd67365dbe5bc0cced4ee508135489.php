<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"D:\phpstudy\PHPTutorial\WWW\wg\public/../application/admin\view\video\edit.html";i:1553564594;}*/ ?>
<style>
    /*预览图片样式*/
    #xmTanImg {
        width: 100px;
                ...
                <div class="page-wrap">
                    ...
                    <form id="formData">
                        <div class="form-group-col-2">
                            ...
                            <div class="form-cont">
                                <input type="text" placeholder="标题" class="form-control form-boxed " name="cten"
                                    id="cten" value="<?php echo $info['cten']; ?>">
                                ...
                                <div class="form-cont">
                                    <select style="width:auto;" name="fid" id="fid">
                                        <?php if(is_array($cate) || $cate instanceof \think\Collection || $cate instanceof \think\Paginator): if( count($cate)==0 ) : echo "" ;else: foreach($cate as $key=>$row): ?>
                                            <option value="<?php echo $row['id']; ?>" <?php if($row['id'] == $info['fid']): ?> selected = "selected" <?php endif; ?>><?php echo $row['cate']; ?></option>
                        ...
                        <div class="form-group-col-2">
                            ...
                            <div class="form-cont">
                                <input type="text" placeholder="视频路径" class="form-control form-boxed " name="vde"
                                    id="vde" value="<?php echo $info['vde']; ?>">
                                <span class="span"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group-col-2">
                            ...
                            <div class="form-cont">
                                <img src="<?php echo $info['pic']; ?>" style="width:100px;height:80px;">
                                <span class="span"></span>
                            </div>
                        </div>
                        <div class="form-group-col-2">
