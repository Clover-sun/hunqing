<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:97:"D:\wamp64\www\mb\wedding_platform\admin\moban\public/../application/admin\view\template\edit.html";i:1552876572;s:92:"D:\wamp64\www\mb\wedding_platform\admin\moban\application\admin\view\AdminPublic\public.html";i:1553483800;}*/ ?>
<!DOCTYPE html>
<html>
<head>
            ...
            <div class="panel-bd">
                <div class="page-wrap">
                    <section class="page-hd">
                        <header>
                            <h2 class="title">模板编辑</h2>
                        </header>
                        <hr>
                    </section>

                    <form id="formData" method="post" enctype="multipart/form-data" action="/template/edits?id=<?php echo $list['id']; ?>">

                        <div class="form-group-col-2">
                            <div class="form-label">模板名称:</div>
                            <div class="form-cont">
                                <input type="text" placeholder="模板名称" class="form-control form-boxed " name="name" id="name" value=<?php echo $list['name']; ?>>
                        ...
                        <div class="form-group-col-2">
                            ...
                            <div>
                                <p>
                                    ...
                                    <!--<img src="<?php echo $list['img']; ?>" style="width: 100px;height: 100px" >-->
                                </p>
                                <!--<img id="xmTanImg" />-->
                                <div id="xmTanDiv"></div>
                            </div>
