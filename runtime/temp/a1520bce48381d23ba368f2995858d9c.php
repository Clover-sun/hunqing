<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"D:\wamp64\www\mb\wedding_platform\admin\moban\public/../application/apps\view\index\see1.html";i:1553849880;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <style>
        * {
        ...
        .one-slide{
            background: url("/static/moban/img/wedding_dress.gif") no-repeat top/contain;
...
<div class="swiper-container">
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide green-slide">
            ...
            <div class="fox fox3">
                <img src="/static/moban/img/m4.jpg" alt="">
    ...
    <!-- 广告-->
    <div class="bg-model-ad"
         style="position:absolute;top:0%;left:0%;display:none;background:rgba(0,0,0,0.7);width:375px;height:666px;z-index:10;">
        <div class="cross_ad"><img src="/static/moban/img/cross.png" alt="" ></div>
        <div class="bg_model_inside"
             style="position:absolute;left:57px;top:14%;border-radius:8px;width:260px;height:340px;">
            <p>注意:图片格式为</p>
            <img src="/static/moban/img/m1.jpg"  style="width:100%;height:100%;" alt="">
        </div>
    </div>
    <!--签到-->
    ...
    $(function () {
        $('.music').on('click', function () {
            if ($(this).hasClass('on')) {
                ...
                $(this).attr('src', '/static/moban/img/off.png');
            } else {
                $('audio').get(0).play();
                $(this).addClass('on music-off');
                $(this).attr('src', '/static/moban/img/on.png');
            }
        });
