<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"/www/wwwroot/szz/public/../application/index/view/temp/see3.html";i:1554171022;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <style>
        * {
        ...
        .guest_ul .last-li a {
            ...
            border-radius: 15px;
            color: white;
            box-shadow: 0 0 0 1px white, 0 0 0 3px darkgreen;
        }
    ...
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide one-slide" >
            ...
            <p class="ani" swiper-animate-effect="fadeInUp" swiper-animate-duration="5s"
               swiper-animate-delay="0.3s" style="position:relative;font-size:23px;">
                <span>诚邀你参加我们的婚礼</span>
            </p>
            <p class="ani" swiper-animate-effect="fadeInUp" swiper-animate-duration="5s"
               swiper-animate-delay="0.3s" style="position:relative;font-size:23px;">
                WEDDING　　INVITATION
        ...
        <div class="swiper-slide grey-slide"
            ...
            <p class="ani" swiper-animate-effect="fadeInDownBig" swiper-animate-duration="3s" swiper-animate-delay="0.3s"
               style="position:relative;">
                在最美好的年华遇见 <br>
                在最美的时光里相爱 <br>
                沉浸在幸福中的我们将于 <br>
        ...
        <div class="swiper-slide goldenrod-slide"
             style="text-align:center;">
            <p class="ani" swiper-animate-effect="zoomIn" swiper-animate-duration="5s" swiper-animate-delay="0.3s">
                <img src="/static/moban/img/m3.jpg" alt="" style="height:200px;">
            </p>
            <p class="ani" swiper-animate-effect="fadeInUpBig" swiper-animate-duration="2s" swiper-animate-delay="0.3s">
                <img src="/static/moban/img/2-1.png" alt="" >
            </p>
            <p class="ani" swiper-animate-effect="fadeIn" swiper-animate-duration="3s" swiper-animate-delay="0.3s">
                新娘:　妮妮
            </p>
            <p class="ani" swiper-animate-effect="zoomIn" swiper-animate-duration="3s" swiper-animate-delay="0.3s">
                兜兜转转遇到你，自此世界美好无比
            </p>
            <p class="ani" swiper-animate-effect="shake" swiper-animate-duration="3s" swiper-animate-delay="0.3s">
                i love you
            </p>
        </div>
        <div class="swiper-slide yellowgreen-slide"
             style="text-align:center;">
            <p class="ani" swiper-animate-effect="zoomIn" swiper-animate-duration="5s" swiper-animate-delay="0.3s">
                <img src="/static/moban/img/m4.jpg" alt="" style="height:200px;">
            </p>
            <p class="ani" swiper-animate-effect="fadeInUpBig" swiper-animate-duration="2s" swiper-animate-delay="0.3s">
                <img src="/static/moban/img/2-1.png" alt="" >
            </p>
        ...
        <div class="swiper-slide orange-slide">
            <p class="ani " swiper-animate-effect="zoomIn" swiper-animate-duration="1.5s"
               swiper-animate-delay="0.5s">
                <img src="/static/moban/img/m5.jpg" alt="">
            ...
            <p class="ani" swiper-animate-effect="fadeInRight" swiper-animate-duration="1.5s"
               swiper-animate-delay="0.5s" style="text-align:right;">
                i love you not because of who you are
            </p>
            <p class="ani " swiper-animate-effect="fadeInLeft" swiper-animate-duration="1.5s"
               swiper-animate-delay="0.5s" style="text-align:right;">
                陪伴是最长情的告白
            </p>
        </div>
        <div class="swiper-slide yellow-slide">
            <p class="ani " swiper-animate-effect="flipInY" swiper-animate-duration="1.5s"
               swiper-animate-delay="0.5s">
        ...
        <div class="swiper-slide grey-slide">
            <p class="ani " swiper-animate-effect="fadeInLeftBig" swiper-animate-duration="1.5s"
               swiper-animate-delay="0.5s">
                <img src="/static/moban/img/2-2.png" alt="">
            </p>
            <p class="ani" swiper-animate-effect="fadeInUp" swiper-animate-duration="1.5s" swiper-animate-delay="0.3s"
               style="position:relative;">
                那一年<br>
                我们偶然相遇<br>
                没想到世界这么大<br>
            ...
            <p class="ani " swiper-animate-effect="flipInX" swiper-animate-duration="5s"
               swiper-animate-delay="0.5s">
                <img src="/static/moban/img/2-1.png" alt="">
            </p>
        </div>
