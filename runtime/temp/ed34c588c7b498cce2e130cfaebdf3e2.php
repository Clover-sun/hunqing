<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"C:\wamp64\www\hunqing\wedding_platform\admin\moban\thinkphp\tpl\dispatch_jump.tpl";i:1553755850;}*/ ?>
...
<meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=0.5, maximum-scale=2.0, user-scalable=yes" />  
    ...
    <title>跳转提示</title>
    <?php if((\think\Request::instance()->isMobile())==true){?>
    <style type="text/css">
