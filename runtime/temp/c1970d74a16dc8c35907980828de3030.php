<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"D:\wamp64\www\mb\wedding_platform\admin\moban\public/../application/index\view\index\add2.html";i:1553847356;}*/ ?>
<!doctype html>
<html lang="en">
        ...
        <form action="/xiu/edit" method="POST" enctype="multipart/form-data">
            <ul class="content">
                ...
                <li>
                    ...
                    <div>
                        <p>
                            <input type="file" id="xdaTanFileImg2" name="file2" onchange="xmTanUploadImg(this)" />
                        </p>
                        <img id="xmTanImg2" />
