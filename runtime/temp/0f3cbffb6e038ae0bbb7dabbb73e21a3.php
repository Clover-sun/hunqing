<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:98:"C:\wamp64\www\hunqing\wedding_platform\admin\moban\public/../application/admin\view\logo\logo.html";i:1553755848;s:97:"C:\wamp64\www\hunqing\wedding_platform\admin\moban\application\admin\view\AdminPublic\public.html";i:1553755848;}*/ ?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-bd">
                ...
                <table class="table table-bordered table-striped mb-15" id="tableExcel">
                    ...
                    <tbody>
                    <tr class="cen">
                        <td><img src="<?php echo $list; ?>" style="width: 200px;height: 200px;"></td>
                        <td>
                            <a href="/logo/edit"><button class="btn btn-primary edit"  name="">编辑</button></a>
                        </td>
                    </tr>
                    </tbody>
                </table>
