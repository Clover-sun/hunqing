<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\phpstudy\PHPTutorial\WWW\wg\public/../application/admin\view\logo\edit.html";i:1552876572;s:77:"D:\phpstudy\PHPTutorial\WWW\wg\application\admin\view\AdminPublic\public.html";i:1553483800;}*/ ?>
<!DOCTYPE html>
<html>
<head>
            ...
            <div class="panel-bd">
                <div class="page-wrap">
                    <section class="page-hd">
                        <header>
                            <h2 class="title">登录编辑</h2>
                        </header>
                        <hr>
                    </section>

                    <form id="formData" method="post" enctype="multipart/form-data" action="/logo/update">

                        <div class="form-group-col-2">
                            <div class="form-label">商家登录背景图片:</div>
                            <div>
                                <p>
