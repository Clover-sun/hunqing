<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:101:"C:\wamp64\www\hunqing\wedding_platform\admin\moban\public/../application/admin\view\tenant\index.html";i:1553755848;s:97:"C:\wamp64\www\hunqing\wedding_platform\admin\moban\application\admin\view\AdminPublic\public.html";i:1553755848;}*/ ?>
<!DOCTYPE html>
<html>
<head>
                ...
                <table class="table table-bordered table-striped mb-15" id="tableExcel">
                    ...
                    <tbody>
                        ...
                        <tr class="cen">
                            ...
                            <td>
                                <a class="pag" name="<?php echo $val['id']; ?>">
                                <?php echo $val['pag']==1?'<p style="color: #6495ED">开启</p>':'<p style="color: red">禁用</p>'; ?>
                                </a>
                            </td>
                            <td>
                                <a class="ale" name="<?php echo $val['id']; ?>">
                                <?php echo $val['ale']==1?'<p style="color: #6495ED">开启</p>':'<p style="color: red">禁用</p>'; ?>
                                </a>
                            </td>
                            <td>
                                <a class="jins" name="<?php echo $val['id']; ?>">
                                <?php echo $val['static']==1?'<p style="color: #6495ED">正常</p>':'<p style="color: red">禁用</p>'; ?>
                                </a>
                            </td>
                            <td>
                                <button class="btn btn-primary fen" name="<?php echo $val['id']; ?>">分配</button>
                                ...
                                <button class="btn btn-warning del" name="<?php echo $val['id']; ?>">删除</button>
