<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\phpstudy\PHPTutorial\WWW\wg\public/../application/admin\view\template\index.html";i:1554346840;s:77:"D:\phpstudy\PHPTutorial\WWW\wg\application\admin\view\AdminPublic\public.html";i:1553483800;}*/ ?>
<!DOCTYPE html>
<html>
<head>
            ...
            <div class="panel-bd">
                ...
                <table class="table table-bordered table-striped mb-15" id="tableExcel">
                    ...
                    <tr class="cen">
                        ...
                        <td>
                            <a href="/template/see?id=<?php echo $vo['id']; ?>" target="_blank">
                            ...
                            <button class="btn btn-primary edit" name="<?php echo $vo['id']; ?>">编辑</button>
                            <!--<a href="/template/delete?id=<?php echo $vo['id']; ?>"><button class="btn btn-danger del" name="">删除</button></a>-->
                            <!--<button class="btn btn-danger del" name="" id="id" value="<?php echo $vo['id']; ?>">删除</button>-->
                            <button class="btn btn-danger del" name="<?php echo $vo['id']; ?>">删除</button>
