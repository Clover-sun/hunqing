<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:99:"C:\wamp64\www\hunqing\wedding_platform\admin\moban\public/../application/index\view\index\add2.html";i:1553831678;}*/ ?>
<!doctype html>
<html lang="en">
...
<body>
    ...
    <ul class="content" style="width:500px;height:auto;margin:50px;text-indent:20px;">
		...
		<li class="last-li" style=" margin:10px 100px;width:260px;font-size:16px;border:1px solid gainsboro;border-radius:8px;font-size:18px;">
			<h3>联系我们</h3>
    ...
    <div class="box">
        <form action="/xiu/edit" method="POST" enctype="multipart/form-data">
            <ul class="content">
                ...
                <li style="height: auto;margin: 0 7%;">
                    <h3 style="margin-top:2%">尾页广告图片</h3>
                    <p></p>
