<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:100:"C:\wamp64\www\hunqing\wedding_platform\admin\moban\public/../application/index\view\index\video.html";i:1553830671;}*/ ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	...
	<div id="container">
		...
		<section class="tab">
			<ul class="ul_kids">
				...
				<li class="kids_list">
					<video src="<?php echo $shi['vde']; ?>" controls controlsList="nodownload" poster="<?php echo $shi['pic']; ?>" ></video>
