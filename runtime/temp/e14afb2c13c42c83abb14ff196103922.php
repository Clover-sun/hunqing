<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:101:"D:\wamp64\www\mb\wedding_platform\admin\moban\public/../application/admin\view\template\editsee2.html";i:1553588302;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide grey-slide">
            ...
            <div class="content" style="font-size:20px;color:red;text-align:left;">
                ...
                <p>时间:<span><?php echo $list['time']; ?></span></p>
