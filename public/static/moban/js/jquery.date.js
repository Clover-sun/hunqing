...
(function (factory) {
    ...
    $('#d-confirm').bind('click',function(){
		...
		if(opt.location){
			that.data('fullDate',y+'年'+m+'月'+d+'日 '+h+'时'+min+'分'+s);
		}
        createDate.show(false);
        createDate.toNow(true);
    })
